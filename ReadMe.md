...
```
### Комментарии
Здесь сначала схватил ошибку, т.к. поменял только время вылета, только потом дошло, что нужно вместе со времени отправления и время прибытия менять, а то как-то нелогично (если бы не было рейсов продолжительностью менее 30 минут, я потенциально мог бы и не обнаружить ошибку)
...
### Ссылка на вторую лабораторную работу
https://github.com/dmitryz1024/db_lab_2